(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Quad = /** @class */ (function () {
                ...
                Quad.prototype.stroke = function (context, color) {
                ...
                Quad.prototype.area = function () {
                    ...
                    var s1Length = this.p1.distance(this.p2);
                    var s2Length = this.p2.distance(this.p3);
                    var bisectLength = this.p1.distance(this.p3);
                    var s3Length = this.p3.distance(this.p4);
                    var s4Length = this.p4.distance(this.p1);
                ...
                Quad.prototype.toString = function () { return "[" + this.p1.toString() + "," + this.p2.toString() + "," + this.p3.toString() + "," + this.p4.toString() + "]"; };
                return Quad;
            }());
            var Splinter = /** @class */ (function () {
                function Splinter(sampler) {
                    this.quads = [];
                    this.slantAmount = .3;
                    this.minQuadArea = 30;
                    this.cellScale = 0;
                ...
                Splinter.prototype.findSplit = function (p1, p2, t) {
                    var dx = p2.x - p1.x;
                    var dy = p2.y - p1.y;
                ...
                Splinter.prototype.splitQuad = function (q) {
                    ...
                    var t2 = Math.random() * this.slantAmount + ((1 - this.slantAmount) / 2);
                    var l1 = q.p1.distance(q.p2) + q.p3.distance(q.p4);
                    var l2 = q.p2.distance(q.p3) + q.p4.distance(q.p1);
                    if (l1 < l2) { // split the quad vertically
                        var splitPoint1 = this.findSplit(q.p2, q.p3, t1);
                        var splitPoint2 = this.findSplit(q.p4, q.p1, t2);
                        var q1h = new Quad(q.p1, q.p2, splitPoint1, splitPoint2);
                        var q2h = new Quad(splitPoint2, splitPoint1, q.p3, q.p4);
                        return [q1h, q2h];
                    }
                    else { // split the quad horizonatally
                        var splitPoint1 = this.findSplit(q.p1, q.p2, t1);
                        var splitPoint2 = this.findSplit(q.p3, q.p4, t2);
                        ;
                        var q1v = new Quad(q.p1, splitPoint1, splitPoint2, q.p4);
                        var q2v = new Quad(splitPoint1, q.p2, q.p3, splitPoint2);
                        return [q1v, q2v];
                    }
                };
                Splinter.prototype.splitAll = function () {
                    var oldQuads = this.quads;
                    this.quads = [];
                    oldQuads.forEach(function splitIt(q) {
                        var newQuads = this.splitQuad(q);
                ...
                Splinter.prototype.addQuad = function (q) {
                    this.quads.push(q);
                };
                return Splinter;
            }());
            ...
            var Sampler = /** @class */ (function () {
                function Sampler(ctx, sourcewidth, sourceheight, targetwidth, targetheight) {
                    this.greyscale = [];
                    this.sourcewidth = 0;
                    this.sourceheight = 0;
                    this.targetwidth = 0;
                    ...
                    var pixCount = sourcewidth * sourceheight;
                    var index = 0;
                    for (var pix = 0; pix < pixCount; pix++) {
                        var value = data[index++] * .3 + data[index++] * .59 + data[index++] * .11;
                        this.greyscale.push(value);
                        index++; // skip the alpha
                    }
                }
                Sampler.prototype.sampleQuad = function (targetQuad) {
                    // need to bounds check against image
                    // need to figure out Y range
                    var sourceQuad = targetQuad.scale(this.scaleX, this.scaleY);
                    var minY = sourceQuad.minY();
                    var maxY = sourceQuad.maxY();
                    var total = 0;
                    var count = 0;
                    // scan from top to bottom of Y range
                    for (var y = minY; y <= maxY; y++) {
                        var xSpan = sourceQuad.xSpan(y);
                        var yRow = Math.floor(y);
                        var xCol = Math.floor(xSpan[0]);
                        if (xSpan.length == 1) { // this probably isn't necessary, but the span checking code theoritically could return one intersection so...
                            var index = yRow * this.sourcewidth + xCol;
            ...
            function Render(ctx, sampler, settings) {
                ...
                var linearScale = settings.cellScale + Math.log2(Math.floor(settings.width / 500));
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.onCloseSettings = function () {
                    this.onToggleSideNav();
                };
                AppComponent.prototype.updateSourceCanvas = function () {
                    var context = this.sourceCanvas.nativeElement.getContext('2d');
                    context.fillStyle = White;
                    context.fillRect(0, 0, this.sourceCanvas.nativeElement.width, this.sourceCanvas.nativeElement.height);
                    var imageWidth = this.image.width;
                    var imageHeight = this.image.height;
                    var displayWidth = this.sourceCanvas.nativeElement.width;
                    var displayHeight = this.sourceCanvas.nativeElement.height;
                    var destWidth = displayHeight;
                    var destHeight = displayHeight;
                ...
                AppComponent.prototype.onImageChange = function (event) {
                    var _this = this;
                ...
                AppComponent.prototype.onStockImagePicked = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var NumInputComponent = /** @class */ (function () {
                function NumInputComponent() {
                }
                NumInputComponent.prototype.ngOnInit = function () {
                };
                NumInputComponent.prototype.getValue = function () {
